...
setappdata(0, 'Class', Class);        %Make 'Class' variable value accessible for other GUIs to parse to Output Interface
assignin('base', 'Class', Class);
 
set(handles.editFinalResult, 'String', Class);    %Display Finalized Result ('CLASS' variable value) in 'editFinalResult' textbox
...
FaceRecogOutput                    %Navigate to Face Recognition Step 1
