<%-- 
    ...
    Created on : 18-Jan-2017, 00:32:32
    Author     : BANDULA
--%>
...
<html>
        ...
        <title>JSP Page</title>
          ...
          <!-- Presentation Layer   -->
           <style>
            ...
            #adminfeedback input[type="password"] {
            ...
            #adminfeedback input[type="submit"] {
            ...
            #adminfeedback input[type="reset"] {
            ...
            #adminfeedback input[type="submit"]:hover{
            ...
            #adminfeedback input[type="reset"]:hover{
    ...
    <body>
        ...
        <%
            ...
            String text=proxy.adminProfile(username);
                 
            String [] textdisplay=text.split("===");
                 
            String userid=textdisplay[0];
                   
            String ar=proxy.studentsentenquire(userid, "ADMINISTRATOR");
        ...
        <h3>Search Enquires Based on these Identities:   &nbsp; &nbsp; &nbsp; &nbsp;
         ...
         <div id="adminfeedback">
            ...
            <form>
                ...
                <center><h2><b> <font style="color: white"> Enquire Received Feedback (Administrators) </font></b></h2> </center> <br> 
                ...
                <h3>Full Name:     &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    <input type="text" id="txtname" name="txtname" placeholder="" style="width: 500px" disabled="true" />  
                    
                </h3> <br> 
                
                <h3>Contact:    &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                    <input type="text" id="txtcontact" name="txtcontact" placeholder="" style="width: 500px" disabled="true"/> &nbsp; &nbsp; &nbsp; 
                ...
                <h3>Email: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    <input type="text" id="txtemail" name="txtemail" placeholder="" style="width: 500px" disabled="true"  /> &nbsp; &nbsp; &nbsp; 
                    
                
                </h3> <br> 
                
                <h3>Purpose: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    <input type="text" id="txtpurpose" name="txtpurpose" placeholder="" style="width: 500px" disabled="true"  /> &nbsp; &nbsp; &nbsp; 
                    
                
                </h3> <br> 
                
                <h3>Send To: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    <input type="text" id="txtsend" name="txtsend" placeholder="" style="width: 500px" disabled="true"  /> &nbsp; &nbsp; &nbsp; 
                    
                
                </h3> <br> 
                
                <h3>Message: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    <input type="text" id="txtmessage" name="txtmessage" placeholder="" style="width: 500px" disabled="true"  /> &nbsp; &nbsp; &nbsp; 
                
                </h3> <br> 
                
                <h3>Student ID: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                    <input type="text" id="txtstudentid" name="txtstudentid" placeholder="" style="width: 500px" disabled="true"  /> &nbsp; &nbsp; &nbsp; 
                    
                
                </h3> <br> 
                
                <h3>Land Lord ID: &nbsp; &nbsp; &nbsp; &nbsp; 
                    <input type="text" id="txtlandlordid" name="txtlandlordid" placeholder="" style="width: 500px" disabled="true"  /> &nbsp; &nbsp; &nbsp; 
                ...
                <h3>Feedback:   &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   
                    <input type="text" id="txtfeedback" name="txtfeedback" placeholder="" style="width: 500px" disabled="true"  /> &nbsp; &nbsp; &nbsp; 
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                <input type="submit" id="btnsubmit" name="btnsearch" value="SEARCH" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
