<%-- 
    Document   : AdminReplication
    Created on : 10-Jan-2017, 00:21:17
    Author     : BANDULA
--%>
...
<html>
    <head>
        ...
        <style>
            ...
            #adminenquireform input[type="text"] {
            ...
            #adminenquireform input[type="password"] {
            ...
            #adminenquireform input[type="submit"] {
            ...
            #adminenquireform input[type="reset"] {
            ...
            #adminenquireform input[type="submit"]:hover{
            ...
            #adminenquireform input[type="reset"]:hover{
    ...
    <body>
           ...
           function send() {
            ...
            if(document.getElementById("txtfullname").value==="" || document.getElementById("txtcontact").value==="" || document.getElementById("txtemail").value==="" || document.getElementById("txtpurpose").value==="" || document.getElementById("txtsend").value==="" || document.getElementById("txtmessage").value==="" || document.getElementById("txtstudentid").value==="" || document.getElementById("txtlandlordid").value==="") {
           ...
           <div id="adminenquireform">
            
             <form onsubmit="send()">
                
                <h2><b> <font style="color: white"> Request Form(Admins) </font></b></h2> <br> 
                ...
                <input type="text" id="txtsend" name="txtsend" placeholder="SendTo" style="width: 400px" /> <br> <br> <br>
