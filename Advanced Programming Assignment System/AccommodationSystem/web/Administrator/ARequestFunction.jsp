<%-- 
    Document   : ARequestFunction
    Created on : 10-Jan-2017, 00:20:57
    Author     : BANDULA
--%>
...
<html>
    <head>
        ...
        <style>
            ...
            #adminrequest input[type="password"] {
            ...
            #adminrequest input[type="submit"] {
            ...
            #adminrequest input[type="submit"]:hover{
            ...
            #adminrequest input[type="reset"]:hover{
    ...
    <body>
        ...
        <%
           ...
           BusinessLogicService proxy=new BusinessLogicService_Service().getBusinessLogicServicePort();
                ...
                String textuser=proxy.adminProfile("username");
            ...
            String [] display=textuser.split("===");
             ...
             String txtrequestids=proxy.adminreceivedenquire(userid, "ADMINISTRATOR");
        ...
        <div id="adminrequest">
            ...
            <form>
                ...
                <h3>Feedback:   &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   
                    <input type="text" id="txtfeedback" name="txtfeedback" placeholder="" style="width: 500px" value="<%= request.getAttribute("Feedback")  %>"  /> &nbsp; &nbsp; &nbsp; 
