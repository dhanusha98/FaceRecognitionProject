<%-- 
    Document   : ManageProperties
    Created on : 09-Jan-2017, 23:43:11
    Author     : BANDULA
--%>
...
<html>
    ...
    <body>
          ...
          <%
            ...
            if(request.getParameter("btnsearch")==null) {
                ...
                String [] tdisplay=arr.split("===");
                      ...
                      String pid=tdisplay[0];
                
                     byte[] image=proxy.propertyimage(pid);
                      
                     String url="data:image/png;base64," +Base64.encode(image);
                     
                     
                     byte[] image2=proxy.secondpropertyimage(pid);
                      
                     String url2="data:image/png;base64," +Base64.encode(image2);
                     
                     byte[] image3=proxy.thirdpropertyimage(pid);
         ...
         <div id="manageproperty">
            ...
            ***Please note that be sure to upload pictures after implementing 'update'/any transaction for records. Otherwise problems will occur***
            ...
            <form>
                ...
                <center><h2><b> <font style="color: white"> Manage Properties </font></b></h2> </center> <br> 
                
              <img src="<%= request.getAttribute("propimg1")  %>" height="400px" width="400px" id="imgprofile" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              <img src="<%= request.getAttribute("propimg2")  %>" height="400px" width="400px" id="imgprofile2" /> <br>   &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
              <img src="<%= request.getAttribute("propimg3")  %>" height="400px" width="400px" id="imgprofile3" />  <br>  
         ...
         <%
                ...
                String PropertyID=request.getParameter("txtid");
                String Propname=request.getParameter("txtname");
                String Proptype=request.getParameter("txtproptype");
                String moredetails=request.getParameter("txtmoredetails");
                String image1=" "; //Not Usable and only to fulfil the insert transaction. No effect for transacion from this variable
                String image2=" "; //Not Usable and only to fulfil the insert transaction. No effect for transacion from this variable
                String image3=" "; //Not Usable and only to fulfil the insert transaction. No effect for transacion from this variable
                String LandLordID=request.getParameter("txtlandlordid");
                 ...
                 if(request.getParameter("btninsert")!=null) {
                     ...
                     String insert=proxy.insertProperty(Propname, Proptype, moredetails, image1, image2, image3, LandLordID);
                   ...
                   String upd=proxy.updateProperty(PropertyID, Propname, Proptype, moredetails, LandLordID);
                   ...
                   String delete=proxy.deleteProperty(PropertyID);
                 ...
                 if(request.getParameter("btnfileupload")!=null) {
                  ...
                  String fileupload1=proxy.insertfirstpropertyimage(PropertyID, filevalue);
               ...
               if(request.getParameter("btnfileupload2")!=null) {
                  ...
                  String fileupload2=proxy.insertfirstpropertyimage(PropertyID, filevalue2);
               ...
               if(request.getParameter("btnfileupload3")!=null) {
                  ...
                  String fileupload3=proxy.insertfirstpropertyimage(PropertyID, filevalue3);
