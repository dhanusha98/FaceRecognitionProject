<%-- 
    ...
    Created on : 09-Jan-2017, 23:29:53
    Author     : BANDULA
--%>
...
<html>
    <head>
        ...
        <style>
            ...
            #studentprofile input[type="password"] {
            ...
            #studentprofile input[type="submit"] {
            ...
            #studentprofile input[type="reset"] {
            ...
            #studentprofile input[type="submit"]:hover{
            ...
            #studentprofile input[type="reset"]:hover{
        ...
        <%
          ...
          ***Please note that be sure to upload pictures after implementing 'update'/any transaction for records. Otherwise problems will occur***
             ...
             <form>
                 ...
                 <input type="hidden" id="txtcheck" name="txtcheck" placeholder="" style="width: 400px" value="" autocomplete="off" /> 
                 <input type="hidden" id="txtheckpass" name="txtcheckpass" placeholder="" style="width: 400px" value="" autocomplete="off"/>        
                 <input type="hidden" id="txtcheckid" name="txtcheckid" placeholder="" style="width: 400px" value="<%= request.getAttribute("userid")  %>" autocomplete="off" /> 
                ...
                <input type="submit" id="btnupdate" name="btnupdate" value="UPDATE" onclick="setupdate()" /> 
         ...
         <script>
              ...
              function setupdate() {
                  ...
                  location.href="http://localhost:8080/AccommodationSystem/Student/StudentProfileModification.jsp";
              }
