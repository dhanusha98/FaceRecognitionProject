        ...
        <input type="submit" value="BACK" onclick="back()" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
         ...
         <div id="enquireform">
             ...
             <form onsubmit="send()">
                 ...
                 <input type="hidden" id="txtusercheck" name="txtusercheck"  style="width: 400px" value="<%= username  %>" />
                 <input type="hidden" id="txtpasscheck" name="txtpasscheck" style="width: 400px"  value="<%= password  %>"/>
                
                <h2><b> <font style="color: white"> Request Form(Students) </font></b></h2> <br> 
                ...
                <input type="text" id="txtpurpose" name="txtpurpose" placeholder="Purpose" style="width: 400px" value="<%= purpose + PropertyID %>" /> <br> <br> <br>
                ...
                <input type="text" id="txtstudentid" name="txtstudentid" placeholder="Student ID" style="width: 400px" value="<%= textval  %>"   /> <br> <br> <br>
