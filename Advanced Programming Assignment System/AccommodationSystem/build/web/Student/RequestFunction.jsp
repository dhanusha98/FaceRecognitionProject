<%-- 
    ...
    Created on : 09-Jan-2017, 23:28:35
    Author     : BANDULA
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            String textuser=proxy.studentProfile(username, password);
            ...
            String txtuseridcheck=request.getParameter("txtuseridcheck");
            
            out.println(txtuseridcheck); */
            
              String txtrequestids=proxy.studentreceivedenquire(userid, "Student"); 
