...
public final class LandLordlLogin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                \n");
      out.write("                <h2><b> <font style=\"color: white\"> User Login (Land Lords) </font></b></h2> <br> \n");
      out.write("                \n");
      ...
      out.write("                 ");
              ...
              BusinessLogicService proxy=new BusinessLogicService_Service().getBusinessLogicServicePort();
               ...
               String validation=proxy.landlordlogin(username, password);
              ...
              String incorrectmessage="INCORRECT USER AUTHENTICATIONS";
               ...
               if(validation.equalsIgnoreCase(successmessage)) {
                   ...
                   String state=new String("http://localhost:8080/AccommodationSystem/LandLord/LandLordMainMenu.jsp?username=" + username +"&password=" + password);
               ...
               session.setAttribute("LandLordSession", "LandLord");
            
            
             out.print(session.getAttribute("LandLordSession"));
            
            Cookie cook = new Cookie("LandLordSession", session.getAttribute("LandLordSession").toString()) ;
